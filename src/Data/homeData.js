...
export const heroContent = {
  description: 'Optera is a platform designed to connect university students with opportunities in projects and internships. Our mission is to bridge the gap between academic knowledge and real-world experience.'
}