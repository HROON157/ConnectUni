...
const BNU_Profile = () => {
  ...
  const [bnuStudents, setBnuStudents] = useState([]);
      ...
      <div className="max-w-6xl mx-auto">
          ...
          <div className="flex flex-col items-center text-center sm:flex-row sm:items-start sm:text-left gap-3 xs:gap-4 sm:gap-6">
            <div className="relative flex-shrink-0">
              ...
              />
              <div className="absolute -bottom-1 -right-1 sm:-bottom-2 sm:-right-2 bg-blue-500 text-white text-xs px-1 xs:px-1.5 py-0.5 sm:px-2 sm:py-1 rounded-full font-semibold">
                Liberal Arts
              </div>
            </div>
            ...
            <div className="flex-1 w-full">
              ...
              <div className="space-y-2 mb-3 xs:mb-4">
                <p className="text-blue-600 font-medium font-['Public_Sans'] flex items-center justify-center sm:justify-start gap-1 text-xs xs:text-sm sm:text-base">
                  ...
                  <span className="text-center sm:text-left">Tarogil, off Raiwind Road, Lahore</span>
                </p>
                <div className="flex flex-wrap justify-center sm:justify-start gap-1 xs:gap-2 sm:gap-4 text-xs">
                  ...
                  <span className="bg-green-100 text-green-800 px-1.5 xs:px-2 py-1 sm:px-3 sm:py-1 rounded-full font-semibold flex items-center gap-1">
                    ...
                    <span className="hidden xs:inline">2.5k-3.5k</span>
                ...
                <div className="text-center p-1.5 xs:p-2 sm:p-3 bg-gray-50 rounded-md xs:rounded-lg">
                  <div className="text-base xs:text-lg sm:text-2xl font-bold text-green-600">1B+</div>
                  <div className="text-xs sm:text-sm text-gray-600">Rupees Aid</div>
                </div>
                <div className="text-center p-1.5 xs:p-2 sm:p-3 bg-gray-50 rounded-md xs:rounded-lg">
                  <div className="text-base xs:text-lg sm:text-2xl font-bold text-purple-600">7</div>
                  <div className="text-xs sm:text-sm text-gray-600">Schools</div>
                </div>
                <div className="text-center p-1.5 xs:p-2 sm:p-3 bg-gray-50 rounded-md xs:rounded-lg">
                  <div className="text-base xs:text-lg sm:text-2xl font-bold text-orange-600">2005</div>
                  <div className="text-xs sm:text-sm text-gray-600">Chartered</div>
                </div>
              </div>
            </div>
          </div>
            ...
            <>
                ...
                <div className="prose prose-sm sm:prose-lg max-w-none">
                  <p className="text-gray-700 leading-relaxed font-['Public_Sans'] text-xs xs:text-sm sm:text-base">
                    ...
                    <span className="bg-blue-100 text-blue-800 px-1 xs:px-1.5 py-0.5 sm:px-2 sm:py-1 rounded font-semibold text-xs sm:text-sm">
                    ...
                    has disbursed over{" "}
                    <span className="bg-green-100 text-green-800 px-1 xs:px-1.5 py-0.5 sm:px-2 sm:py-1 rounded font-semibold text-xs sm:text-sm">
                ...
                <div className="border-l-4 border-blue-500 pl-2 xs:pl-3 sm:pl-6 bg-blue-50 p-2 xs:p-3 sm:p-6 rounded-r-lg">
                  <p className="text-gray-700 leading-relaxed font-['Public_Sans'] text-xs xs:text-sm sm:text-lg">
          ...
          {activeTab === "students" && (
            <div className="bg-white rounded-lg xs:rounded-xl shadow-lg p-3 xs:p-4 sm:p-8">
              ...
              {loading ? (
              ...
              ) : bnuStudents.length > 0 ? (
                <div className="space-y-2 xs:space-y-3 sm:space-y-4">
                  {bnuStudents.map((student) => (
                    <div
                      key={student.id}
                ...
                <div className="text-center py-6 xs:py-8 sm:py-12">
                  ...
                  <p className="text-gray-400 text-xs xs:text-sm sm:text-base">
                    No BNU students have completed their profiles yet.
                  </p>
                </div>
              )}
            </div>
            ...
            <div className="bg-white rounded-lg xs:rounded-xl sm:rounded-2xl max-w-2xl w-full max-h-[98vh] xs:max-h-[95vh] sm:max-h-[90vh] overflow-y-auto shadow-2xl">
              ...
              <div className="p-3 xs:p-4 sm:p-6">
                <div className="text-center mb-3 xs:mb-4 sm:mb-6">
                  ...
                  <p className="text-blue-600 font-medium mb-1 text-xs xs:text-sm sm:text-base">
