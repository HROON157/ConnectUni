...
const PastApplications = () => {
  ...
  // Use ref to avoid dependency issues and cache HR profiles
  ...
  // Optimized fetch past applications
  const fetchPastApplications = useCallback(async () => {
    try {
      ...
      snapshot.docs.forEach((docSnap) => {
        ...
        // Only include past applications
  ...
  // Get status badge for past applications
